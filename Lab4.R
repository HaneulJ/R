...
L1$result1 <- L1$sal *2 # <- L1[["sal"]]*2


# 문제2
L2 <- list("scott",c(100,200,300)) # sep(100,300,100)
...
mean(unlist(L6)) # 중첩된 리스트도 unlist로 벡터 변환 가능!
